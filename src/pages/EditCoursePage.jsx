...
const EditCoursePage = ({handleEditCourse}) => {
    ...
    const [courseDesc, setcourseDesc] = useState(courseData.description);
    const [fee, setFee] = useState(courseData.fee);
    const [courseLocation, setCourseLocation] = useState(courseData.courseLocation);
    const [schedule, setSchedule] = useState(courseData.schedule);
    const [duration, setDuration] = useState(courseData.duration);
    const [learningObjectives, setLearningObjectives] = useState(courseData.learningObjectives);
    const [instructorName, setinstructorName] = useState(courseData.instructor.name);
    const [instructorbackground, setInstructorbackground] = useState(courseData.instructor.background);
    const [email, setEmail] = useState(courseData.instructor.email);
    const [phone, setPhone] = useState(courseData.instructor.phone);
    ...
    const handleSubmit = (e) =>{
        ...
        handleEditCourse(newCourseData);
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea 
                            ...
                            name="description"
                            rows = "4"
                            className="border rounded w-full py-2 px-3 mb-2 whitespace-pre-line"
